...
public class HelloWorld {
    public static void main(String[] args) {
        ...
        RuntimeWiring runtimeWiring = RuntimeWiring.newRuntimeWiring()
                ...
                .type("Query", builder -> builder.dataFetcher("test", new StaticDataFetcher("world")))
                .build();
        ...
        // 执行查询
        ExecutionResult executionResult = graphQL.execute("{test}");
